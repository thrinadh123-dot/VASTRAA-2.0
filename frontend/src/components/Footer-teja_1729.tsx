            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-6">
                ...
                <div className="md:col-span-4">
                    ...
                    <div className="flex gap-4">
                        <a href="https://instagram.com/vastraa_official" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 border border-[#e8e8e8] rounded-full flex items-center justify-center text-[#9a9a9a] hover:text-[#0a0a0a] hover:border-[#0a0a0a] transition-colors">
                            <FiInstagram strokeWidth={1.5} className="w-3.5 h-3.5" />
                        </a>
                        <a href="https://twitter.com/vastraa_official" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-8 h-8 border border-[#e8e8e8] rounded-full flex items-center justify-center text-[#9a9a9a] hover:text-[#0a0a0a] hover:border-[#0a0a0a] transition-colors">
