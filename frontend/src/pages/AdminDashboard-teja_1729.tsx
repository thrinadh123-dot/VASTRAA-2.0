                                ...
                                <tbody>
                                    {products.map(p => (
                                        <tr key={p._id} className="border-b border-gray-100 hover:bg-gray-50">
                                            <td className="py-3 px-4 text-xs font-mono text-gray-500">{p._id?.substring(0, 8) || 'NEW'}</td>
                                ...
                                <tbody>
                                    {loadingOrders ? (
                                        ...
                                        <tr key={order._id} className="border-b border-gray-100 hover:bg-gray-50">
                                            <td className="py-3 px-4 text-xs font-mono text-gray-500">{order._id?.substring(0, 8) || 'NEW'}</td>
                                            <td className="py-3 px-4">{(order.user as any)?.username || (order.user as any)?.name || 'Customer'}</td>
                                ...
                                <tbody>
                                    {users.map(u => (
                                        <tr key={u._id} className="border-b border-gray-100 hover:bg-gray-50">
                                            <td className="py-3 px-4 text-xs font-mono text-gray-500">{u._id?.substring(0, 8) || 'NEW'}</td>
