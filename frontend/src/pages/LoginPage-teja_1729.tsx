            ...
            <footer className="mt-8 pb-6 w-full">
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 px-4 text-[11px] text-[#aaa] tracking-wide">
                    ...
                    <div className="flex gap-5">
                        <Link to="/legal/privacy" className="hover:text-[#0a0a0a] transition-colors">Privacy Policy</Link>
                        <Link to="/legal/terms" className="hover:text-[#0a0a0a] transition-colors">Terms of Service</Link>
                    </div>
                </div>
            </footer>
        </div>
