...
const OrderPage = () => {
            ...
            <body>
                <div class="header">
                    ...
                    <div class="invoice-info">
                        ...
                        <strong>Date:</strong> {order?.createdAt ? new Date(order.createdAt).toLocaleDateString() : 'N/A'}<br>
                ...
                <div class="section">
                    ...
                    ${order?.shippingAddress?.city || 'N/A'}, ${order?.shippingAddress?.state || ''} ${order?.shippingAddress?.pincode || ''}<br>
                ...
                <div class="totals">
                    ...
                    <div class="total-row grand-total"><span>Total:</span> <span>₹${(order?.totalAmount || order?.totalPrice || 0).toLocaleString('en-IN')}</span></div>
                </div>
    ...
    const date = order?.createdAt ? new Date(order.createdAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' }) : 'N/A';
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            >
                                ...
                                <div className="min-w-0">
                                    <p className="text-base font-bold text-[#1a1a1a] mb-2">{order?.shippingAddress?.fullName || 'N/A'}</p>
                                    <div className="space-y-1">
                                        <p className="text-sm text-[#444] font-medium leading-relaxed">{order?.shippingAddress?.address || 'N/A'}</p>
                                        <p className="text-sm text-[#444] font-bold">{order?.shippingAddress?.city || 'N/A'}, {order?.shippingAddress?.state || 'N/A'} – {order?.shippingAddress?.pincode || 'N/A'}</p>
                                    </div>
                            ...
                            >
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest">Est. {order?.createdAt ? new Date(new Date(order.createdAt).getTime() + 4 * 24 * 60 * 60 * 1000).toLocaleDateString() : 'TBD'}</p>
                                </div>
