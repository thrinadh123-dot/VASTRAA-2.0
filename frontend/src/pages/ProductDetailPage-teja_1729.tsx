...
/** Smooth animated accordion (Controlled) */
    ...
    const breakdown = useMemo(() => {
        ...
        if (reviews.length > 0) {
            reviews.forEach((r: any) => {
                const rRating = Math.floor(r.rating);
                    ...
                    <div className="lg:sticky lg:top-[88px] lg:self-start space-y-5">
                        ...
                        <div className="border-t border-[#ebebeb] mt-2">
                            <Accordion
                                ...
                                onToggle={() => setOpenSection(prev => prev === 'description' ? null : 'description')}
                            >
                            ...
                            <Accordion
                                ...
                                onToggle={() => setOpenSection(prev => prev === 'shipping' ? null : 'shipping')}
                            >
                        ...
                        <div className="space-y-6">
                                ...
                                {visibleReviews.length > 0 ? (
                                    visibleReviews.map((review: any) => (
                                        <motion.div
                                            ...
                                            className="bg-[#fafaf9] rounded-2xl p-5 border border-[#f0f0f0]"
                                        >
                                    ...
                                    <div className="py-12 text-center bg-[#fafaf9] rounded-3xl border-2 border-dashed border-[#ebebeb]">
                                        <p className="text-[#9a9a9a] font-medium tracking-wide">Be the first to review this product</p>
                                    </div>
                                )}
                            </AnimatePresence>
                            ...
                            {reviews.length > 3 && (
                                <button
                                    ...
                                    className="w-full py-4 text-[10px] font-black uppercase tracking-[0.2em] text-[#0a0a0a] border-2 border-[#1a1a1a] rounded-2xl hover:bg-[#1a1a1a] hover:text-white transition-all active:scale-[0.98]"
                                >
